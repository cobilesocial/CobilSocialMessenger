...
import com.quickblox.socialmessenger.ui.settings.ChangePasswordActivity;
import com.quickblox.socialmessenger.ui.splash.SplashActivity;
...
//                                });
//                        diologBuilder.show();
            Toast.makeText(this, this.getString(com.quickblox.core.R.string.connection_lost), Toast.LENGTH_LONG).show();
        }
    }
}