...
import com.quickblox.core.utils.FinderUnknownFriends;
...
public class QBMultiChatHelper extends QBBaseChatHelper {
    ...
    public QBDialog createGroupChat(String name, List<Integer> friendIdsList, boolean isRoom) throws QBResponseException, XMPPException, SmackException {
        ArrayList<Integer> occupantIdsList = ChatUtils.getOccupantIdsWithUser(friendIdsList);
