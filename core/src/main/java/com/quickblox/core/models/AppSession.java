...
public class AppSession implements Serializable {
    ...
    public static AppSession load() {
        ...
        String userLogin = helper.getPref(PrefsHelper.PREF_USER_LOGIN, ConstsCore.EMPTY_STRING);
    ...
    public void closeAndClear() {
        PrefsHelper helper = PrefsHelper.getPrefsHelper();
        helper.delete(PrefsHelper.PREF_USER_LOGIN);
    ...
    private void saveUser(QBUser user, PrefsHelper prefsHelper) {
        ...
        prefsHelper.savePref(PrefsHelper.PREF_USER_LOGIN, user.getLogin());
